...
public class PaginatedMenuContext extends MenuContext {
    ...
    public <T> void attachSlot(MenuSlot<T> menuSlot) {
        ...
        viewContext.slot(menuSlot.getSlot(), menuSlot.getItem()).onClick(viewSlotClickContext -> {
            MenuSlotClick<T> menuSlotClick = new MenuSlotClickImpl<>(menuSlot, ClickType.valueOf(viewSlotClickContext.getClickIdentifier()), viewSlotClickContext.getPlayer(), viewSlotClickContext.getItemWrapper().asBukkitItem(), viewSlotClickContext.getSlot());
